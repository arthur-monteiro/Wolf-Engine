	...
	glm::mat4 projection, float near, float far)
{
	...
	outputImageLayout.binding = 6;

	m_outputTexture = engineInstance->createTexture();
	m_outputTexture->create(engineInstance->getWindowSize(), VK_IMAGE_USAGE_STORAGE_BIT, VK_FORMAT_R32G32B32A32_SFLOAT, VK_SAMPLE_COUNT_1_BIT, VK_IMAGE_ASPECT_COLOR_BIT);
...
void Wolf::DirectLightingPBR::update(glm::vec3 lightDirectionInViewPosSpace)
{
